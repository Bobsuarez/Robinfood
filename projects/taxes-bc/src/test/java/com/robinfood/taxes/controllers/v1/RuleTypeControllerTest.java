...
@WebMvcTest(controllers = RuleTypeController.class)
@TestPropertySource(properties = {
    "jwt.token.mod=taxesBc"
})
class RuleTypeControllerTest extends BaseTestController {
    ...
    void test_findAll_Should_Return200_When_ValidData() throws Exception {
        ...
        String token = getJWT(modules, PermissionsConstants.LIST_RULE_TYPES, audience);
        ...
        //Mock
        when(ruleTypeService.findAll()).thenReturn(ruleTypesList);

        //Call to code to test
        this.mockMvc.perform(get("/v1/rule-types")
