...
class StoreIdentifierTypeSerializerTest {
    ...
    @InjectMocks
    private StoreIdentifierTypeSerializer serializer;
    ...
    private StoreIdentifierType data;

    @BeforeEach
    public void setUp() {
        data = StoreIdentifierType.builder()
            .id(TEST_LONG)
    ...
    void test_When_ConstructorIsPrivate() throws Exception {
        Constructor<StoreIdentifierTypeSerializer> constructor = StoreIdentifierTypeSerializer.class
