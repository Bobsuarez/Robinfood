package com.robinfood.orderorlocalserver.configs;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.robinfood.orderorlocalserver.dtos.apiresponsebuilder.ApiErrorResponseDTO;
import com.robinfood.orderorlocalserver.dtos.security.UserDTO;
...
import static com.robinfood.orderorlocalserver.constants.ApiConstants.DEFAULT_LOCALE;
import static com.robinfood.orderorlocalserver.constants.ApiConstants.UNAUTHORIZED_REQUEST;
...
public class JwtAuthorizationFilter extends OncePerRequestFilter {
    ...
    private void denyRequest(@NotNull final HttpServletResponse response) {
        try (PrintWriter writer = response.getWriter()) {
            ...
            apiResponse.setStatus(HttpStatus.UNAUTHORIZED);//aqui
    ...
    private Claims getTokenClaims(@NotNull final String jwtToken) {
        ...
        final List<String> tokenMods = (List<String>) (claims.get("mod"));
