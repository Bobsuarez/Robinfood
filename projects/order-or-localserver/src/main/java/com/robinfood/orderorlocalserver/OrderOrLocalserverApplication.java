package com.robinfood.orderorlocalserver;
...
@SpringBootApplication(
		scanBasePackages = {
				"com.robinfood.orderorlocalserver.*",
		}
)
@EnableFeignClients(basePackages = {"com.robinfood.orderorlocalserver.*"})

public class OrderOrLocalserverApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(OrderOrLocalserverApplication.class, args);
	}
