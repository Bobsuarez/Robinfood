...
import static com.robinfood.storeor.configs.constants.APIConstants.DEFAULT_LOCALE;
import static com.robinfood.storeor.configs.constants.APIConstants.DEFAULT_STRING_VALUE;
import static com.robinfood.storeor.configs.constants.APIConstants.UNAUTHORIZED_REQUEST;
...
public class JwtAuthorizationFilter extends OncePerRequestFilter {
    ...
    private void denyRequest(@NotNull final HttpServletResponse response) {
        try (PrintWriter writer = response.getWriter()) {
            ...
            apiResponse.setStatus(HttpStatus.UNAUTHORIZED.name());
