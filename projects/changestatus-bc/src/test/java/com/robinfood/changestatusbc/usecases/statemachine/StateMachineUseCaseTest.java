...
import com.robinfood.changestatusbc.factories.state.ApprovedState;
import com.robinfood.changestatusbc.factories.state.DefaultState;
...
class StateMachineUseCaseTest {
    ...
    void statemachine_Exception_test() {
        ...
        assertThrows(GenericChangeStatusBcException.class, () -> stateMachineUseCase.invoke(
                orderStateDTOActual,orderStateDTOnext,listStateSystem,1L));
