package com.robinfood.changestatusor.utilities;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.DeserializationFeature;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.robinfood.changestatusor.constants.GlobalConstants;
...
public final class  ObjectMapperSingleton {
    ...
    public static <T> T jsonToClass(final String json, final Class<T> elementClass) {
        ...
        try {
            ...
            throw new GenericChangeStatusOrException(ex);
        }
    }
