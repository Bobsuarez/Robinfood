...
import com.robinfood.core.dtos.queue.ChannelDTO;
...
public class OrderCreatedMappers {
    ...
    private OrderCreatedQueueDTO toOrderCreatedDTO(
        ...
        orderCreatedQueueDTO.setChannel(
                ChannelDTO.builder()
                        .id(requestOrderDTO.getOrigin().getId())
                        .name(requestOrderDTO.getOrigin().getName())
                        .build()
        );
