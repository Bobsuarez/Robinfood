...
class RestExceptionHandlerTest {
    ...
    @Test
    void test_method_Argument_Type_Mismatch_Exception() {

        // Arrange
        String errorMessage = "Resource Not Found";

        MissingRequestValueException exception = new MissingRequestValueException(
                errorMessage
        );

        // Act
        ResponseEntity<Object> response = handler.methodArgumentTypeMismatchException(
                exception
        );
    ...
    @Test
    void test_Generic_Order_Bc_Exception() {

        // Arrange
        String errorMessage = "Resource Not Found";

        GenericOrderBcException exception = new GenericOrderBcException(
                errorMessage
        );

        // Act
        ResponseEntity<Object> response = handler.genericException(
                exception
        );
    ...
    @Test
    void test_handle_Response_Status_Exception() {
        ...
        // Act
        ResponseEntity<Object> response = handler.handleResponseStatusException(
                exception
        );
