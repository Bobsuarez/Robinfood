...
public class OrderDTODataMock {
    ...
    private List<DiscountDTO> discountDTOListProductDiscountProductIdIsNull = new DiscountDTODataMock().getDataDefaultList_With_Product_ProductId_Is_Null();
    ...
    public OrderDTO getDataDefaultWithoutDiscountsProductIdIsNull() {
        return new OrderDTO(
                1L,
                brandDTO,
                0.0,
                "ABC123",
                1L,
                discountDTOListProductDiscountProductIdIsNull,
                finalProductDTOList,
                BigDecimal.ONE,
                orderFlagDTO,
                true,
    ...
    public List<OrderDTO> getDataDefaultListWithoutDiscountsProductIdIsNull() {
        return Collections.singletonList(getDataDefaultWithoutDiscountsProductIdIsNull());
    }
}
