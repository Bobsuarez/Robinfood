...
class CreateOrderDiscountUseCaseTest {
    ...
    void test_Create_Order_Discount() {
        ...
        orderFinalProductEntity.setSku("123456789");
    ...
    @Test
    void test_Create_Order_Without_Discounts() {
        ...
        orderFinalProductEntity.setSku("123456789");
        List<OrderFinalProductEntity> listProductFinal = List.of(orderFinalProductEntity);
        orderDiscountEntityList.get(0).setOrderFinalProductId(null);
        ...
        Boolean result = createOrderDiscountUseCase
                .invoke(inputOrderDTODataMock.getDataDefaultListWithoutDiscountsProductIdIsNull(), Collections.singletonList(1L))
                .join();
