...
import com.robinfood.app.mocks.TransactionResultPaymentMethodMock;
...
public class PaymentMethodControllerTest {
    ...
    @Mock
    private ISendMsgAcceptedOrRejectedToQueueUseCase sendMsgAcceptedOrRejectedToQueueUseCase;
    @InjectMocks
    private PaymentMethodController paymentMethodController;
    final TransactionResultPaymentMethodMock transactionResultPaymentMethodMock = new TransactionResultPaymentMethodMock();
    @BeforeEach
    void setUp() {
    ...
    @Test
    void test_payment_method_successful() throws Exception {
        final AbstractBuilderApiResponseDTO<Boolean> apiResponseDTOBuilder = new OkApiResponseDTO<>();
        apiResponseDTOBuilder.build("Payment Method Response Receive Successfully");
        mockMvc.perform(MockMvcRequestBuilders
                        .post(PAYMENT_METHODS_V1 + "/transaction/response")
                        .content(ObjectExtensions.toJson(transactionResultPaymentMethodMock.buildTransaction()))
