...
public class MenuHallProductDetailResponseMocks {
    ...
    public static MenuHallProductDetailResponse aMenuHallProductDetailResponse() {
    ...
    public static MenuHallProductDetailDTO aMenuHallProductDTO() throws JsonProcessingException {
        ...
        return modelMapper.map(aMenuHallProductDetailResponse(), MenuHallProductDetailDTO.class);
    }
}
