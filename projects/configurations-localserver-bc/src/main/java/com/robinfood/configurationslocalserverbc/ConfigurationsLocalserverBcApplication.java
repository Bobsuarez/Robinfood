package com.robinfood.configurationslocalserverbc;
...
public class ConfigurationsLocalserverBcApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(ConfigurationsLocalserverBcApplication.class, args);
    }
