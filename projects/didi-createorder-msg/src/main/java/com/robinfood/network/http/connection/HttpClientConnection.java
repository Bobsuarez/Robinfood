...
public class HttpClientConnection {
    ...
    public String connectionProcess(
        ...
        return connectionProcess(Collections.emptyMap(), requestBodyData, attribute, token, url);
    }
    ...
    public String connectionProcess(
        ...
        Request request = buildHttp(requestBodyData, token, url, headers);
    ...
    private Request buildHttp(Object dataBody, String token, String url, Map<String, String> headers) {
