...
class ChangeOrderStatusPosHandlerTest {
    ...
    @Test
    void test_ChangeOrderStatusPosHandler() {
        ...
        ChangeOrderStatusPosHandler changeOrderStatusPosHandler = new ChangeOrderStatusPosHandler(sendMessageUseCase);

        changeOrderStatusPosHandler.handleRequest(APIGatewayRequestDTOMock.buildWithBody(body), context);
    ...
    @Test
    void test_ChangeOrderStatusPosHandler_Should_SecurityException_When_NoFound_Token() {
        ...
        ApiGatewayResponseDTO responseDTO = changeOrderStatusPosHandler
                .handleRequest(
    ...
    @Test
    void test_ChangeOrderStatusPosHandler_Should_BuildConstructor_When_MethodInvoke() {

        ChangeOrderStatusPosHandler changeOrderStatusPosHandler = new ChangeOrderStatusPosHandler();
        Assertions.assertNotNull(changeOrderStatusPosHandler);
    }
