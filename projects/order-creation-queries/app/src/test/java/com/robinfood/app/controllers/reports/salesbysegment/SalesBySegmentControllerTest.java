...
class SalesBySegmentControllerTest {
    ...
    void test_getPosResolution_Request_OK() throws Exception {
        ...
        when(getSalesBySegmentUseCase.invoke(
                anyList(), anyList(), any(LocalDateTime.class), anyList(), anyList())
        ).thenReturn(SaleBySegmentResponseDTO.builder().build());

        mockMvc.perform(MockMvcRequestBuilders
                .get(REPORT_V1 + "/sales")
                .header(HttpHeaders.AUTHORIZATION, BEARER_AUTH + TOKEN)
                .queryParam("dateTimeCurrent", "2023-01-26T20:00:00")
