package com.robinfood.app.controllers.orders.ordersstore;
...
public class OrdersStoreControllerTest {
    ...
    @Test
    void test_getOrderStore_Request_OK() throws Exception {
        when(getOrdersStoreUseCase.invoke(any(DataOrderStoreRequestDTO.class)))
                .thenReturn(new Result.Success<>(OrderStoreDTOMock.getDataDefault()));
        mockMvc.perform(MockMvcRequestBuilders
                .get(ORDERS_V1  + "/store/164/orders")
    ...
    @Test
    void test_getOrderStore_Should_BadRequest_When_EndPointGenerateError() throws Exception {
        when(getOrdersStoreUseCase.invoke(any(DataOrderStoreRequestDTO.class)))
