...
import com.robinfood.app.usecases.getsearchcriteria.GetSearchCriteriaUseCase;
...
class SearchCriteriaControllerTest {
    ...
    @Test
    void test_invoke_Should_GetSearchCriteria_When_invokeCommand() throws Exception {

        when(getSearchCriteriaUseCase.invoke())
                .thenReturn(List.of(SearchCriteriaDTO.builder().build()));

        mockMvc.perform(MockMvcRequestBuilders
                .get(SEARCH_CRITERIA_V1  + SEARCH_CRITERIA)
