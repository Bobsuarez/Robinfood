...
class OrdersDailyControllerTest {
    ...
    @MockBean
    private IGetOrdersDailyUseCase getOrdersDailyUseCase;

    @Test
    void Test_Orders_Daily_Success() throws Exception {
        when(getOrdersDailyUseCase.invoke(anyLong(), anyString()))
    ...
    @Test
    void Test_Orders_Daily_Error() throws Exception {
        when(getOrdersDailyUseCase.invoke(anyLong(), anyString()))
