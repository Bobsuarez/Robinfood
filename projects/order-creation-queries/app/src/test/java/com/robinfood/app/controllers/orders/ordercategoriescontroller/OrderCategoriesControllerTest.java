...
class OrderCategoriesControllerTest {
    ...
    @MockBean
    private IGetOrderCategoryUseCase iGetOrderCategoryUseCase;

    @Test
    void test_getOrderCategory_Should_OK_When_DataIsCorrect() throws Exception {
        when(iGetOrderCategoryUseCase.invoke(any(DataRequestOrderCategoryDTO.class)))
    ...
    @Test
    void test_getOrderCategory_Should_BadRequest_When_EndPointGenerateError() throws Exception {
        when(iGetOrderCategoryUseCase.invoke(any(DataRequestOrderCategoryDTO.class)))
