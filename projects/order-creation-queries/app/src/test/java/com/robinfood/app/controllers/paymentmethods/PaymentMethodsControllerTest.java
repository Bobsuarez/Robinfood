...
class PaymentMethodsControllerTest {
    ...
    @Test
    void test_When_getDataListPaymentMethods_Should_Request_OK() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                .get(PAYMENT_METHODS_V1 + PAYMENT_METHODS)
    ...
    @Test
    void test_getDataListPaymentMethods_Should_BadRequest_When_EndPointGenerateError() throws Exception {
        when(getListPaymentMethodsUseCase.invoke())
