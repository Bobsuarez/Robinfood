...
import com.robinfood.app.mocks.StatusFilterDTOMock;
import com.robinfood.app.usecases.getliststatuscustomfilter.GetStatusCustomFilterUseCase;
...
public class OrderStatusFilterControllerTest {
    ...
    @MockBean
    private GetStatusCustomFilterUseCase getStatusFilterUseCase;

    @Test
    void test_getStatusFilter_Request_OK() throws Exception {

        when(getStatusFilterUseCase.invoke())
                .thenReturn(new Result.Success<>(StatusFilterDTOMock.getDataDefaultList()));

        mockMvc.perform(MockMvcRequestBuilders
                .get(STATUS_V1  + "/status-custom-filter")
    ...
    @Test
    void test_getConfigCompanies_Should_BadRequest_When_EndPointGenerateError() throws Exception {
