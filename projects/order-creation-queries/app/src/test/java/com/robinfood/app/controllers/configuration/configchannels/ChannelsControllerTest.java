package com.robinfood.app.controllers.configuration.configchannels;
...
public class ChannelsControllerTest {
    ...
    @Test
    void test_getConfigChannels_Request_OK() throws Exception {

        when(getConfigChannelsUseCase.invoke()).thenReturn(new Result.Success<>(ConfigChannelsDTOMock.getDataDefault()));

        mockMvc.perform(MockMvcRequestBuilders
                .get(CHANNELS_V1  + "/channels")
