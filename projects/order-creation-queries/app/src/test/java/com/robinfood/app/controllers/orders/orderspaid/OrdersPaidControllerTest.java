...
import com.robinfood.app.usecases.getorderspaid.GetOrdersPaidUseCase;
...
public class OrdersPaidControllerTest {
    ...
    @MockBean
    private GetOrdersPaidUseCase getOrdersPaidUseCase;

    @Test
    void test_invoke_Should_GetOrdersPaidUseCase_When_invokeCommand() throws Exception {

        when(getOrdersPaidUseCase.invoke(any(DataOrdersPaidRequestDTO.class)))
                .thenReturn(new Result.Success<>(OrdersPaidResponseDTOMock.getDataDefault()));

        mockMvc.perform(MockMvcRequestBuilders
                .get(ORDER_PAID_V1  + "/paid-orders")
