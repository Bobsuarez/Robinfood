...
import com.robinfood.core.mocks.dto.CouponDTOMock;
...
class OrderDetailPrintRepositoryTest {
    ...
    private  final DataElectronicBillingEntity dataElectronicBillingEntity = DataElectronicBillingEntity.builder()
    ...
    private  final ElectronicBillEntity electronicBillEntity = ElectronicBillEntity.builder()
    ...
    @Test
    void test_GetOrderDetailPrint_Returns_Successfully() throws Exception {
        when(orderBcQueriesAPI.getOrderDetailPrint(
                token,
                orderIds,
                orderUids,
    ...
    @Test
    void test_GetOrderDetailPrint_Data_Null_Returns_Successfully() throws Exception {
        when(orderBcQueriesAPI.getOrderDetailPrint(
                token,
                orderIds,
                orderUids,
    ...
    @Test
    void test_GetOrderDetailPrint_Product_Without_Data_Null_Returns_Successfully() throws Exception {
        when(orderBcQueriesAPI.getOrderDetailPrint(
                token,
                orderIds,
                orderUids,
    ...
    @Test
    void test_GetOrderDetailPrint_Returns_With_Failure() throws Exception {
        when(orderBcQueriesAPI.getOrderDetailPrint(
                token,
                orderIds,
                orderUids,
