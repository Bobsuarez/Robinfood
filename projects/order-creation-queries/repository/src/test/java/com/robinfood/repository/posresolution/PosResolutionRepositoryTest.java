...
class PosResolutionRepositoryTest {
    ...
    @Mock
    private Call<APIResponseEntity<GetPosResolutionsDTO>> mockOrderTotalDailySales;
    ...
    @Test
    void test_GetPosReturnResolution_Should_OK_When_DataIsCorrect() throws Exception {

        when(orderBcQueriesAPI.getPosResolutionsSequence(
                anyLong(),
                any(LocalDate.class),
                any(LocalDate.class),
                anyString(),
        ...
        when(mockOrderTotalDailySales.execute()).thenReturn(Response.success(
                new APIResponseEntity<>(
                        200,
                        PosResolutionDTOMock.getDataDefault(),
                        "CO",
        ...
        posResolutionRepository.getDataPosResolution(DataPosResolutionRequestDTO.builder()
                .posId(1L)
    ...
    @Test
    void test_GetPos_Should_BadRequest_When_ApiContainsError() throws Exception {
