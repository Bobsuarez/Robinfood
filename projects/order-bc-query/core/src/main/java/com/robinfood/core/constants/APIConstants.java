...
public final class APIConstants {
    ...
    public static final String PAYMENT_METHODS_V1 = "/api/v1/payment-methods";
    ...
    public static final String ORDER_STATUS_HISTORY_BY_UUID = "/{uuid}/status-history";
    ...
    public static final String ORDER_GET_PAYMENT_METHODS = "/orders-payment/{posId}/detail";
    public static final String ORDER_BY_TRANSACTION_ID = "/{id}/order-by-transaction-id";

    public static final String ORDER_GET_SERVICES = "/services";
    ...
    public static final String ORDERS_CATEGORIES = "/{posId}/categories";
    public static final String ORDERS_CANCELLATION = "/api/v1/paid-orders";
    ...
    public static final String STORE_ORDER = "/store/{storeId}/orders";
    ...
    public static final String REPORT_SALES_BY_IDS_COMPANY_LIST = "/sales/companies/orders";

    public static final String REPORT_SALES_BY_SEGMENT = "/sales";

    public static final String REPORT_SALES_BY_STORE_GROUP_PAYMENT_METHODS = "/sales/store/{storeId}/payment-methods";
