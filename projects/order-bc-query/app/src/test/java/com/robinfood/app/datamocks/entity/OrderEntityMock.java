...
public class OrderEntityMock {
    ...
    public static List<OrderEntity> getDataDefaultList() {
        return Collections.singletonList(getDataDefault());
    }

    public static Map<Long, List<OrderEntity>> getDataMapOrderEntity() {
        return OrderEntityMock.getDataDefaultList()
                .stream()
                .collect(Collectors.groupingBy(OrderEntity::getCompanyId));
    }
