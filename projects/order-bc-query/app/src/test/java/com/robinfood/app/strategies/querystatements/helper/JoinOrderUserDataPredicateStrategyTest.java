...
class JoinOrderUserDataPredicateStrategyTest<T> {
    ...
    @InjectMocks
    private JoinOrderUserDataPredicateStrategy<T> joinOrderUserDataPredicateStrategy;
    ...
    void TestBuildPredicate() {
        ...
        joinOrderUserDataPredicateStrategy
