 ...
 */
@Component
public class OrderHistoryFilterBasicStrategy implements IOrderHistoryFilterStrategy {

    private final IOrdersRepository ordersRepository;

    public OrderHistoryFilterBasicStrategy(IOrdersRepository ordersRepository) {
