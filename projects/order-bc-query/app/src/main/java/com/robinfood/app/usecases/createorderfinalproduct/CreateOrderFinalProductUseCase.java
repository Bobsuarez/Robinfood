...
public class CreateOrderFinalProductUseCase implements ICreateOrderFinalProductUseCase {
    ...
    public CompletableFuture<Boolean> invoke(
        ...
        log.info(
                ...
                finalProductsDTO, orderId, companyId, storeId);
    ...
    private OrderFinalProductEntity buildOrderFinalProductEntity(
        ...
        setFinalProductName(finalProduct, orderFinalProductEntity);
    ...
    private void calculateAndSetPrices(
        ...
        log.info(
                ...
                finalProduct, orderFinalProductEntity);
        ...
        final Double productPrice = (
                orderFinalProductEntity.getBasePrice() * orderFinalProductEntity.getQuantity()
        ) + orderFinalProductEntity.getProductsPrice();
        ...
        values.put(GlobalConstants.PRODUCT_PRICE, productPrice);
    ...
    private void setFinalProductName(
            FinalProductDTO finalProductDTO,
            OrderFinalProductEntity orderFinalProductEntity
    ) {
        String sizeName = finalProductDTO.getSize().getName();

        if ((orderFinalProductEntity.getFinalProductName().trim()).startsWith(sizeName)
                && !sizeName.isEmpty()
        ) {
            orderFinalProductEntity.setFinalProductName(
                    orderFinalProductEntity.getFinalProductName().substring(sizeName.length() + 1)
            );
        }
    }
