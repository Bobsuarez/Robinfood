 ...
 */
@Component
public class OrderHistoryFilterSearchTextNonNullAndChannelIdsNonNullStrategy implements IOrderHistoryFilterStrategy {

    private final IGetUsersByFullNameLikeAndLocalDateUseCase getUsersByFullNameLikeAndLocalDate;
    private final IOrdersRepository ordersRepository;


    public OrderHistoryFilterSearchTextNonNullAndChannelIdsNonNullStrategy(
